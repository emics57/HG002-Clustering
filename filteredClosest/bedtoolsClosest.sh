...
for ((i=0; i<${#items[@]}; i++)); do
    bedtools closest -k 4 -a /Users/emilyxu/Desktop/cdrproject/filteredIntersectUniques/"${items[i]}"_filtered.bed -b  /Users/emilyxu/Desktop/cdrproject/filteredIntersectUniques/"${items[i]}"_filtered.bed -d > "${items[i]}"_closest_filtered.bed
done
